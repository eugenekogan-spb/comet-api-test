...
def show_model_settings():
    ...
    st.markdown("### Доступные модели Comet")
    
    # Список популярных моделей Comet
    models_info = {
        "comet-7b": {
            "name": "Comet 7B",
            "description": "Базовая модель 7 миллиардов параметров",
            "max_tokens": 4000,
            "recommended_temp": 0.7
        },
        "comet-13b": {
            "name": "Comet 13B", 
            "description": "Улучшенная модель 13 миллиардов параметров",
            "max_tokens": 4000,
            "recommended_temp": 0.7
        },
        "comet-70b": {
            "name": "Comet 70B",
            "description": "Мощная модель 70 миллиардов параметров",
            "max_tokens": 4000,
            "recommended_temp": 0.7
        }
    }
